 ...
 */
package com.profesorfalken.jservices.util;
...
public class ServicesUtils {
    ...
    public static String executeCommand(String... command) {
        ...
        try {
            ...
            Logger.getLogger(ServicesUtils.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private static String readData(Process process) {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(ServicesUtils.class.getName()).log(Level.SEVERE, null, ioe);
            }
        }
